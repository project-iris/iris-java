...
public interface SubscribeApi {
    ...
    void subscribe(@NotNull final String topic, @NotNull SubscriptionHandler handler) throws IOException;
    ...
    void unsubscribe(@NotNull final String topic, @NotNull final SubscriptionHandler handler) throws IOException;
}