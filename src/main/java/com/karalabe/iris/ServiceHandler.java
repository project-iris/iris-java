...
public interface ServiceHandler {
     ...
     */
    default byte[] handleRequest(@NotNull final byte... request) { throw new ProtocolException("Not implemented!"); }
    ...
    default void handleTunnel(@NotNull final Tunnel tunnel) { tunnel.close(); }

    /** Callback notifying the service that the local relay dropped its connection. */
    default void handleDrop(@NotNull final ProtocolException e) { throw new ProtocolException(e); }
}
