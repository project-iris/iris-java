...
public final class Iris {
    ...
    public static Connection connect(final int port) {
    ...
    public static Service register(final int port, @NotNull final String cluster, @NotNull final ServiceHandler handler) throws InterruptedException {
    ...
    public static Service register(final int port, @NotNull final String cluster, @NotNull final ServiceHandler handler, @NotNull final ServiceLimits limits) {
